...
class DateFormatters {
  ...
  DateFormat yMDSlash = DateFormat('yyyy/MM/dd');
  DateFormat mD = DateFormat('MMMM dd');
  DateFormat dM = DateFormat('dd MMMM');
  DateFormat dMM = DateFormat('dd/MM');
  DateFormat dMySlash = DateFormat('dd/MM/yyyy');
  DateFormat hMA = DateFormat('hh:mm a');
  DateFormat hA = DateFormat('hh a');
  ...
  DateFormat eee = DateFormat('EEE');
  DateFormat mmm = DateFormat('MMM');
  ...
  DateFormat dayString = DateFormat('EEE');
